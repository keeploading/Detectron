...
class LineExtractor(Config):
        ...
        for parabola_param_np, classes_param, parabola_box, boundary in zip(parabola_param_list, classes_param_list, parabola_box_list, boundarys):
            ...
            for index, parabola in enumerate(parabola_param_np):
                if index == index_param:
                    ...
                    predict_parabola = self.get_parabola_by_distance(good_parabola, parabola[5] - y)
    ...
    def get_parabola_by_distance(self, coefficient, distance):
        A = coefficient[0]
        B = coefficient[1]
        C = coefficient[2]
        ...
        if A == 0:
            ...
            return self.get_parabols_by_points([point1, point2, point3])


    def get_parabols_by_points(self, points):
        x1 = points[0][0]
        y1 = points[0][1]
        x2 = points[1][0]
        y2 = points[1][1]
